...
import { ArrowRight, Download, Shield, Mail, Terminal as TerminalIcon, Sparkles } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-[1fr_20rem] gap-10 lg:gap-14 items-start">
            ...
            <aside className="lg:sticky lg:top-24 self-start w-full">
              <div className="rounded-2xl border border-blue-200/70 bg-white overflow-hidden shadow-lg shadow-blue-500/10">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="mb-8 sm:mb-10 max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-slate-400 mt-3 leading-relaxed">
              ...
              <code className="font-mono text-blue-300 bg-blue-500/10 border border-blue-500/25 rounded px-1.5 py-0.5">
                help
              </code>{" "}
